    ...
    for c in cloud:
        ...
        if l is None:
            actions.append(SyncAction(
                normalized_id=nid, cloud_name=c.name, local_name="",
                action="NEW_PULL", reason="exists in cloud, missing local",
                pull_target=pull_target, cloud_digest=c.digest, local_digest="",
                cloud_modified_at=c.modified_at, local_modified_at=""
            ))
            continue
        ...
        actions.append(SyncAction(
            normalized_id=nid, cloud_name=c.name, local_name=l.name,
            action=action, reason=reason, pull_target=pull_target,
            cloud_digest=c.digest, local_digest=l.digest,
            cloud_modified_at=c.modified_at, local_modified_at=l.modified_at
        ))
    return actions
