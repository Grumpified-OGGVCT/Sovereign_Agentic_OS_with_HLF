...
| **14-Hat Review** | `governance/templates/fourteen_hat_review.md` | Every Jules PR |
| **Gold Hat Sign-Off** | `AGENTS.md` § Gold Hat | Terminal gate — every PR before merge |
...
| Total Tests | **2046+** (pytest collected) |
