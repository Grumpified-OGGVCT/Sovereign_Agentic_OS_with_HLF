...
def check_in():
    ...
    try:
        ...
        # 3. Commit and Push
        subprocess.run(["git", "commit", "-m", f"Autonomous Node Check-in: {time.strftime('%Y-%m-%d %H:%M:%S')}"], capture_output=True)
