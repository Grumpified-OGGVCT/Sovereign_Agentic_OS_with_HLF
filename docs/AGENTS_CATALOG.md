...
| 29 | 🧑 Peer Review: Sovereign Agentic OS & HLF v0.4.0 | `persona` | Reviewer: AI Systems Architect (Gemini 3.1 Pro) Verified by: Build team (Antigra | `governance/peer_review.md` |
...
| 124 | ⚡ Capability Enum (catalog_agents) | `capability` | Defines 9 capability values: out_path, format, out_path, out_path, parents, exis | `scripts/catalog_agents.py` |
| 125 | ⚡ Capability Enum (credential_vault) | `capability` | Defines 4 capability values: models, models, last_verified, is_valid | `agents/core/credential_vault.py` |
...
Reviewer: AI Systems Architect (Gemini 3.1 Pro) Verified by: Build team (Antigravity + project lead) Date: 2026-03-01 Scope: HLF Compiler Pipeline, Security Gates, Phase 5.2 VM Roadmap
...
### ⚡ Capability Enum (catalog_agents)

Defines 9 capability values: out_path, format, out_path, out_path, parents, exist_ok, encoding, file, __name__

| Property | Value |
|----------|-------|
| **Category** | `capability` |
| **Source** | `scripts/catalog_agents.py` |
...
| __name__ | Capability Enum (catalog_agents) |
| abs | HLF Module: math |
...
| encoding | Capability Enum (catalog_agents) |
...
| out_path | Capability Enum (catalog_agents), Capability Enum (catalog_agents), Capability Enum (catalog_agents) |
| parents | Capability Enum (catalog_agents) |
